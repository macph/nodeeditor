...
dropDraftConnection()
{
  ...
  auto draftConnectionId = _draftConnection->connectionId();

  auto port = getRequiredPort(draftConnectionId);
  ...
  handleDroppedDraftConnection(scenePos, draftConnectionId);
}
